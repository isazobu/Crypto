...
public class MatrixOperations {
	...
	public static void ayarla(Character[][][] cubes,int yuz,int yuz2)
	{
		...
		tümdegerler.add(numberone(cubes,yuz,0,0)); // 1.bölgededeki toplam sayýnýn modu var.
		tümdegerler.add(numberone(cubes,yuz,0,3)); // 2.bölgededeki toplam sayýnýn modu var.
		tümdegerler.add(numberone(cubes,yuz,3,0)); // 3.bölgededeki toplam sayýnýn modu var.
		tümdegerler.add(numberone(cubes,yuz,3,3)); // 4.bölgededeki toplam sayýnýn modu var.
		for(int i=0;i<4;i++)
		{
